    ...
    public static class EGuestDALConfig
    {
        public static void RegisterTypes(IUnityContainer container)
        {
            container
                ...
                .RegisterType<IRepositoryAsync<FeatureDetail>, Repository<FeatureDetail>>(new PerResolveLifetimeManager())
                .RegisterType<IRepositoryAsync<FeatureDetailTranslation>, Repository<FeatureDetailTranslation>>(new PerResolveLifetimeManager())
                ...
                .RegisterType<IRepositoryAsync<Entities.Model.Category>, Repository<Entities.Model.Category>>(new PerResolveLifetimeManager())
