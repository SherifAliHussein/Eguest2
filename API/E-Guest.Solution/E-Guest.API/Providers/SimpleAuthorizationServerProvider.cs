...
namespace E_Guest.API.Providers
{
    public class SimpleAuthorizationServerProvider: OAuthAuthorizationServerProvider
    {
        ...
        public override Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            {
                if (exception.ErrorCode == ErrorCodes.UserDeleted)
                {
                    context.SetError("user deleted", "The user is deleted.");
                ...
                else if (exception.ErrorCode == ErrorCodes.UserDeactivated)
                {
                    context.SetError("user deactivated", "The user is deleted.");
                    //Add your flag to the header of the response
                    context.Response.Headers.Add("X-Challenge",
                        new[] { ((int)HttpStatusCode.Unauthorized).ToString() });
                    return Task.FromResult<object>(null);
