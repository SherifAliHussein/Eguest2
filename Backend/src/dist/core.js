...
;(function() {
  ...
  .module('core').config(["$translateProvider","appCONSTANTS",function($translateProvider,appCONSTANTS){
        ...
        var en_translations = {
            ...
            "RoomLbl":"Room",
            "AddRoomBtn":"Add Room",
            "RoomAddSuccess":"Room added successfuly",
            "NewRoomLbl":"New Room",
            "RoomUserPasswordLbl":"Room password",
            "RoomDeleteSuccess":"Room deleted successfuly",
            "UpdateRoomLbl":"Update Room",
            "RoomUpdateSuccess":"Room updated successfuly",
            "NoroomsAvailable": "there is no Rooms",
...
/////////////////////////Restaurants en
        ...
        var ar_translations = {
            ...
            "RoomLbl":"غرف",
            "AddRoomBtn":"اضف غرفة",
            "RoomAddSuccess":"تم ادخال غرفة بنجاح",
            "NewRoomLbl":"غرفة جديد",
            "RoomUserPasswordLbl":"كلمة المرور غرفة",
            "RoomDeleteSuccess":"تم حذف غرفة بنجاح",
            "UpdateRoomLbl":"تحديث غرفة",
            "RoomUpdateSuccess":"تم تحديث غرفة بنجاح",
            "NoroomsAvailable": "لا يوجد غرف",
            ...
            "roomsLimitConsumedLbl":"المجموع الغرف / المستخدم",
